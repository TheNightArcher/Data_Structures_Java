...
public class ArrayDeque<E> implements Deque<E> {
    ...
    private void insertAndShiftRightSide(int realIndex, E element) {
    ...
    private void insertAndShiftLeftSide(int realIndex, E element) {
